...
function f6() {
    // d6 += [d6.length - 1] + ',' + i6.value; //wrong!!!

    // let nextFreeIndex = d6.length;
    // d6[nextFreeIndex] = i6.value;
...
function f11() {
    ...
    let t = d11.indexOf(i11);
    out11.innerHTML = t;
    // let t = d11.indexOf(+document.querySelector('.i-11').valuei11);
    // document.querySelector('.out-11')out11.innerHTML = t;
